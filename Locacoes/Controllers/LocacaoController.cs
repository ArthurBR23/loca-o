...
namespace Locacoes.Controllers
{
    public class LocacaoController : Controller
    {
        ...
        {
            ViewBag.ClienteId = new SelectList(await _context.Clientes.ToListAsync(), "Id", "Nome");
            ViewBag.VeiculoId = new SelectList(await _context.Veiculo.ToListAsync(), "Id", "Modelo");
        ...
        public async Task<IActionResult> Create([Bind("Id,DataLocacao,ValorTotal,ClienteId, VeiculoId")] Locacao locacao)
        {
